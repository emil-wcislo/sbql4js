...
var DivideExpression = function (_BinaryExpression) {
    _inherits(DivideExpression, _BinaryExpression);

    function DivideExpression(leftExpr, rightExpr) {
        _classCallCheck(this, DivideExpression);

        return _possibleConstructorReturn(this, (DivideExpression.__proto__ || Object.getPrototypeOf(DivideExpression)).call(this, leftExpr, rightExpr));
    }
