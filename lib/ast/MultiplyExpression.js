...
var MultiplyExpression = function (_BinaryExpression) {
    _inherits(MultiplyExpression, _BinaryExpression);

    function MultiplyExpression(leftExpr, rightExpr) {
        _classCallCheck(this, MultiplyExpression);

        return _possibleConstructorReturn(this, (MultiplyExpression.__proto__ || Object.getPrototypeOf(MultiplyExpression)).call(this, leftExpr, rightExpr));
    }
